...
def run_ddp_training(rank, world_size, master_addr, master_port, num_epochs=10, timeout = 1):
    ...
    # criacao do dataset com dados sinteticos
    X_train, y_train, X_test, y_test = generate_dummy_data() 
    input_dim = X_train.shape[1]
    output_dim = 1
    train_dataset = TensorDataset(X_train, y_train)

    # divide os dados entre os nós
